		...
		menuPrincipal: function () {
			...
			$.ajax(settings).done(function (dataMenu) {
				...
				$.each(PoloMenu, function (i, field) {
					...
					menu.append('<li class="itemMenu cat' + field.id + ' cat-index-' + i + '"><a href="' + field.url + '?PS=40&O=OrderByPriceASC" title="' + field.name + '">' + field.name + '</a><div class="box-subMenu"><div class="container-center"><ul class="subCategoria"></ul></div></div></li>');
					...
					$(PoloMenu[i].children).each(function (ii, el) {
						...
						$('.cat-index-' + i).find('.subCategoria').append('<li id="' + subCatId + '" class="subItem"><a href="' + subCatUrl + '?PS=40&O=OrderByPriceASC" class="linkBy">' + subCatNome + '</a></li>');
					});
							...
							if (answer1 >= answer2 + answer3 + answer4 && answer1 != answer2 && answer1 != answer3 && answer1 != answer4) {
								document.querySelector('.result').innerHTML = `
									...
									<div class="box-cupom">
										...
										<a class="link" href="/264?PS=40&map=productClusterIds&O=OrderByPriceASC">Acesse a coleção</a>
									</div>
								`
								...
								document.querySelector('.result').innerHTML = `
									...
									<div class="box-cupom">
										...
										<a class="link" href="/268?PS=40&map=productClusterIds&O=OrderByPriceASC">Acesse a coleção</a>
									</div>
								`
								...
								document.querySelector('.result').innerHTML = `
									...
									<div class="box-cupom">
										...
										<a class="link" href="/265?PS=40&map=productClusterIds&O=OrderByPriceASC">Acesse a coleção</a>
									</div>
								`
								...
								document.querySelector('.result').innerHTML = `
									...
									<div class="box-cupom">
										...
										<a class="link" href="/266?PS=40&map=productClusterIds&O=OrderByPriceASC">Acesse a coleção</a>
									</div>
								`
								...
								document.querySelector('.result').innerHTML = `
									...
									<div class="box-cupom">
										...
										<a class="link" href="/267?PS=40&map=productClusterIds&O=OrderByPriceASC">Acesse a coleção</a>
									</div>
								`
							}
						}
