!(function(e) {
    ...
    (t.prototype.animateSlide = function(i, t) {
        var o = {},
            s = this;
        s.animateHeight(), !0 === s.options.rtl && !1 === s.options.vertical && (i = -i), !1 === s.transformsEnabled ?
            ...
            (!0 === s.options.rtl && (s.currentLeft = -s.currentLeft),
                e({ animStart: s.currentLeft }).animate({ animStart: i }, {
            ...
            (s.applyTransition(),
                (i = Math.ceil(i)), !1 === s.options.vertical ? (o[s.animType] = "translate3d(" + i + "px, 0px, 0px)") : (o[s.animType] = "translate3d(0px," + i + "px, 0px)"),
                s.$slideTrack.css(o),
                t &&
                setTimeout(function() {
        ...
        !0 === i.options.arrows &&
            ((i.$prevArrow = e(i.options.prevArrow).addClass("slick-arrow")),
                ...
                (i.$prevArrow.removeClass("slick-hidden").removeAttr("aria-hidden tabindex"),
                    ...
                    i.htmlExpr.test(i.options.nextArrow) && i.$nextArrow.appendTo(i.options.appendArrows), !0 !== i.options.infinite && i.$prevArrow.addClass("slick-disabled").attr("aria-disabled", "true")) :
    ...
    (t.prototype.cleanUpEvents = function() {
        ...
        i.options.dots && null !== i.$dots && e("li", i.$dots).off("click.slick", i.changeSlide).off("mouseenter.slick", e.proxy(i.interrupt, i, !0)).off("mouseleave.slick", e.proxy(i.interrupt, i, !1)),
            i.$slider.off("focus.slick blur.slick"), !0 === i.options.arrows && i.slideCount > i.options.slidesToShow && (i.$prevArrow && i.$prevArrow.off("click.slick", i.changeSlide), i.$nextArrow && i.$nextArrow.off("click.slick", i.changeSlide)),
            ...
            i.cleanUpSlideEvents(), !0 === i.options.accessibility && i.$list.off("keydown.slick", i.keyHandler), !0 === i.options.focusOnSelect && e(i.$slideTrack).children().off("click.slick", i.selectHandler),
    ...
    (t.prototype.getLeft = function(e) {
        ...
        return (
            (s.slideOffset = 0),
            (t = s.$slides.first().outerHeight(!0)), !0 === s.options.infinite ?
            ...
            s.slideCount <= s.options.slidesToShow && (a = s.slideOffset = 0), !0 === s.options.centerMode && !0 === s.options.infinite ?
            (s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2) - s.slideWidth) :
            !0 === s.options.centerMode && ((s.slideOffset = 0), (s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2))),
            (i = !1 === s.options.vertical ? e * s.slideWidth * -1 + s.slideOffset : e * t * -1 + a), !0 === s.options.variableWidth &&
            ((o = s.slideCount <= s.options.slidesToShow || !1 === s.options.infinite ? s.$slideTrack.children(".slick-slide").eq(e) : s.$slideTrack.children(".slick-slide").eq(e + s.options.slidesToShow)),
                (i = !0 === s.options.rtl ? (o[0] ? -1 * (s.$slideTrack.width() - o[0].offsetLeft - o.width()) : 0) : o[0] ? -1 * o[0].offsetLeft : 0), !0 === s.options.centerMode &&
    ...
    (t.prototype.init = function(i) {
        ...
        e(t.$slider).hasClass("slick-initialized") ||
            ...
            i && t.$slider.trigger("init", [t]), !0 === t.options.accessibility && t.initADA(),
    ...
    (t.prototype.initDotEvents = function() {
        var i = this;
        !0 === i.options.dots && i.slideCount > i.options.slidesToShow && e("li", i.$dots).on("click.slick", { message: "index" }, i.changeSlide), !0 === i.options.dots && !0 === i.options.pauseOnDotsHover && e("li", i.$dots).on("mouseenter.slick", e.proxy(i.interrupt, i, !0)).on("mouseleave.slick", e.proxy(i.interrupt, i, !1));
    }),
    ...
    (t.prototype.initializeEvents = function() {
        ...
        i.initArrowEvents(),
            ...
            e(document).on(i.visibilityChange, e.proxy(i.visibility, i)), !0 === i.options.accessibility && i.$list.on("keydown.slick", i.keyHandler), !0 === i.options.focusOnSelect && e(i.$slideTrack).children().on("click.slick", i.selectHandler),
    ...
    (t.prototype.removeSlide = t.prototype.slickRemove = function(e, i, t) {
        var o = this;
        return (
            (e = "boolean" == typeof e ? (!0 === (i = e) ? 0 : o.slideCount - 1) : !0 === i ? --e : e), !(o.slideCount < 1 || e < 0 || e > o.slideCount - 1) &&
    ...
    (t.prototype.setCSS = function(e) {
        ...
        !0 === o.options.rtl && (e = -e),
            ...
            (s[o.positionProp] = e), !1 === o.transformsEnabled || (!(s = {}) === o.cssTransitions ? (s[o.animType] = "translate(" + i + ", " + t + ")") : (s[o.animType] = "translate3d(" + i + ", " + t + ", 0px)")),
            o.$slideTrack.css(s);
    }),
    ...
    (t.prototype.setFade = function() {
        ...
        t.$slides.each(function(o, s) {
                (i = t.slideWidth * o * -1), !0 === t.options.rtl ? e(s).css({ position: "relative", right: i, top: 0, zIndex: t.options.zIndex - 2, opacity: 0 }) : e(s).css({ position: "relative", left: i, top: 0, zIndex: t.options.zIndex - 2, opacity: 0 });
            }),
    ...
    (t.prototype.setSlideClasses = function(e) {
        ...
        a.$slides.eq(e).addClass("slick-current"), !0 === a.options.centerMode ?
            ((i = Math.floor(a.options.slidesToShow / 2)), !0 === a.options.infinite &&
    ...
    (t.prototype.slideHandler = function(e, i, t) {
        ...
        return (
            ...
            (!1 === i && d.asNavFor(e),
                ...
                (d.currentLeft = null === d.swipeLeft ? n : d.swipeLeft), !1 === d.options.infinite && !1 === d.options.centerMode && (e < 0 || e > d.getDotCount() * d.options.slidesToScroll) ?
                void(!1 === d.options.fade &&
                    ((o = d.currentSlide), !0 !== t ?
    ...
    (t.prototype.swipeMove = function(e) {
        var i,
            ...
            n = this;
        return (
            (a = void 0 !== e.originalEvent ? e.originalEvent.touches : null), !(!n.dragging || (a && 1 !== a.length)) &&
            ((i = n.getLeft(n.currentSlide)),
                (n.touchObject.curX = void 0 !== a ? a[0].pageX : e.clientX),
                (n.touchObject.curY = void 0 !== a ? a[0].pageY : e.clientY),
                (n.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(n.touchObject.curX - n.touchObject.startX, 2)))), !0 === n.options.verticalSwiping && (n.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(n.touchObject.curY - n.touchObject.startY, 2)))),
                "vertical" !== (t = n.swipeDirection()) ?
                (void 0 !== e.originalEvent && 4 < n.touchObject.swipeLength && e.preventDefault(),
                    (s = (!1 === n.options.rtl ? 1 : -1) * (n.touchObject.curX > n.touchObject.startX ? 1 : -1)), !0 === n.options.verticalSwiping && (s = n.touchObject.curY > n.touchObject.startY ? 1 : -1),
                    ...
                    ((o = n.touchObject.swipeLength * n.options.edgeFriction), (n.touchObject.edgeHit = !0)), !1 === n.options.vertical ? (n.swipeLeft = i + o * s) : (n.swipeLeft = i + o * (n.$list.height() / n.listWidth) * s), !0 === n.options.verticalSwiping && (n.swipeLeft = i + o * s), !0 !== n.options.fade && !1 !== n.options.touchMove && (!0 === n.animating ? ((n.swipeLeft = null), !1) : void n.setCSS(n.swipeLeft))) :
                void 0)
        );
    }),
    ...
    (e.fn.slick = function() {
        var e,
            ...
            n = o.length;
        for (e = 0; e < n; e++)
            if (("object" == typeof s || void 0 === s ? (o[e].slick = new t(o[e], s)) : (i = o[e].slick[s].apply(o[e].slick, a)), void 0 !== i)) return i;
        return o;
    });
}),
...
var commonStore = {
        init: function() {
            this.setup(), this.loginBefore(), this.newsletterFooter(), this.newsletterSidebar(), this.verificaLogado();
        },
        setup: function() {
        ...
        //         console.log(e), e.IsUserDefined ? ((isLogin = !0), (userEmail = e.Email), $(".nav-user li.logout").show(), $(".msg-welcome").show().find(".name").html(e.FirstName)) : ((isLogin = !1), $(".nav-user li.login").show());
        //     });
        // },
        ...
        carrosselVideoCollection: function(e, i) {
            $(e).slick({
                infinite: !1,
                dots: i,
                slidesToShow: 1,
            ...
            $(".ft-line-1 .btn-send").click(function() {
                ...
                function validate() {
                    ...
                    if (validateEmail(fcEmail)) {
                        ...
                        $(".ft-line-1 #send-news").append("<p class='error'>Preencha um e-mail vÃ¡lido</p>");
                    }
                    return false;
                }
        ...
        newsletterSidebar: function() {
            $(".sidebar-contato .btn-send").click(function() {
                function validateEmail(fcEmail) {
                    var re = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
                    return re.test(fcEmail);
                }

                var varN = $(".sidebar-contato #txtname").val();
                var varE = $(".sidebar-contato #txtemail").val();

                function validate() {
                    var fcEmail = $(".sidebar-contato #txtemail").val();
                    if (validateEmail(fcEmail)) {
                        enviaDados();
                    } else {
                        $(".sidebar-contato #txtemail").css("border-bottom", "1px solid #e74c3c");
                        $(".sidebar-contato #send-news").append("<p class='error'>Preencha um e-mail vÃ¡lido</p>");
                    }
                    return false;
                }

                $(".sidebar-contato .btn-send").css("border", "1px solid #d5d5d5");


                if (varN == "") {
                    $(".sidebar-contato #txtname").css("border-bottom", "1px solid #e74c3c");
                    $(".sidebar-contato #send-news").append("<p class='error'>Preencha o campo destacado</p>");
                    setTimeout(function() {
                        $(".sidebar-contato #txtname").css("border-bottom", "1px solid #cdcdcd");
                        $(".sidebar-contato .error").remove();
                    }, 5000);
                } else if (varE == "") {
                    $(".sidebar-contato #txtemail").css("border-bottom", "1px solid #e74c3c");
                    $(".sidebar-contato #send-news").append("<p class='error'>Preencha o campo destacado</p>");
                ...
                function enviaDados() {
                    ...
                    $.ajax({
                        ...
                        url: "/api/dataentities/NL/documents",
                        success: function(data) {
                            $(".sidebar-contato #send-news").html(
                                "<p id='msgSucesso'>Pronto. Em breve você receberá novidades =)</p>"
                            );
                        },
                        error: function(error) {}
    ...
    imgProduct = {
        ...
        slider: function() {
            if ($("body").hasClass("jb-produto")) {
                ...
                if (video !== undefined) {
                    $("ul.slider-nav").append("<li class='video-thumb'><img src='/arquivos/jb-video-prod.jpg' alt='video'/></li>");
                    $("ul.slider-for").append(video);
                }
                $(".slider-for").slick({
                        infinite: !1,
                        slidesToShow: 1,
...
var configMobile = {
    ...
    map = {
        ...
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â": "A",
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£": "a",
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢": "A",
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âª": "e",
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â¦ ": "E",
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨": "e",
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â¹ÃƒÂ¢Ã¢â€šÂ¬ ": "E",
        "ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©": "e",
    ...
    util = {
        init: function() {
            this.thumbVideo(), this.navPage(), this.topPage(), this.navTabs(), this.closeLightbox(), this.showLightbox(), this.hideLightbox(), this.inputEmpty();
        },
            ...
            $(".form-custom").on("click", ".send-custom", function() {
                    ...
                    if ("" == e) $("#c-name").addClass("empty").focus();
                        ...
                        if ("" == o) $("#message").addClass("empty").focus();
                            ...
                            setTimeout(function() {
                                $.ajax({ headers: contentHeaders, url: "/api/dataentities/FJ/documents", async: !1, crossDomain: !0, type: "POST", data: JSON.stringify(a) })
                                    .success(function(e) {
                                        s.removeClass("load"),
    ...
    pgHome = {
        init: function() {
            ...
            commonStore.carrosselVideoCollection("video-txt-container", !0);
        },
        setup: function() {
    ...
    pgProduct = {
        init: function() {
            this.setup(),
                ...
                commonStore.carrosselCollectionProductPage(".collection.group-similares h2 + ul", !1),
                configMobile.init(),
                addWishlist.init(),
                this.shipping(),
                this.disccount();
        ...
        setup: function() {
            ...
            if (
                ...
                s < 10 && (s = "0" + s),
                    ...
                    (aro =
                        '<ul class="row a_topic a_Aro"><li class="specification">Tamanho:</li><li class="select-aros"><div class="row">' +
                        o +
        ...
        event: function() {
            $(".share-product").on("click", ".pop", function() {
                ...
                $("body").on("click", ".select-aros .select", function() {
                    $(".aro-2 input")
                        .attr("placeholder", "Aliança 2 (João " + dateAlianca + ")")
                        .slideDown(),
                        $(".aro-2").slideDown(),
...
$(document).ready(function() {
    ...
    $('.enviarFormNews').on('click', function() {
...
$('.floating-button-contact ul li.side').click(function() {
    $('.sidebar-contato').show().animate({ right: "0%" }, 500);
});
$('.head-contato-frame').click(function() {
    $('.sidebar-contato').animate({ right: "-120%" }, 500);
    if ($(window).width() <= 375) {
        $('.sidebar-contato').animate({ right: "-150%" }, 500);
    }
});
$(window).scroll(function() {
    if ($(window).scrollTop() + $(window).height() == $(document).height()) {
        $('.floating-button-contact').addClass('hide');
    } else {
        $('.floating-button-contact').removeClass('hide');
    }
});
...
var aro = {
    abreAro: function(){
        setTimeout(function(){
            $(document).ready(function() {
                $('.Aro .group_1, .aro-1 .a_Aro .select-aros .row').hide();
            });
            $('.Aro .specification, .aro-1 .a_Aro .specification').click(function() {
                $('.Aro .group_1, .aro-1 .a_Aro .select-aros .row').slideToggle();
            });
        
            $('.Aro .group_1 label, .aro-1 .a_Aro li.select-aros .row .select').click(function() {
                var text = $(this).text();
                $('.info-product .ct .sku-selector-container .Aro .specification, .aro-1 .a_Aro .specification').text(`Tamanho: ${text}`);
                $('.Aro .group_1, .a_Aro li.select-aros .row').slideUp();
                $('.info-product .ct .sku-selector-container .Aro .specification:after, .aro-1 .a_Aro .specification:after').css('display', 'none');
            }); 
        }, 1000);
    },
    abreAro2: function(){
        setTimeout(function(){
            $('.aro-2 .a_Aro .specification').click(function() {
                $('.aro-2 .a_Aro .select-aros .row').slideToggle();
            });
        
            $('.aro-2 .a_Aro li.select-aros .row .select').click(function() {
                var text = $(this).text();
                $('.aro-2 .a_Aro .specification').text(`Tamanho: ${text}`);
                $('.aro-2 .a_Aro li.select-aros .row').slideUp();
                $('.aro-2 .a_Aro .specification:after').css('display', 'none');
            });
        }, 1000); 
    },
    init: function(){
...
aro.init();
// BANNERS CUSTOMIZADOS PARA COLEÇÕES. SÓ FUNCIONA DESSA FORMA.

var bannersCustomizados = {
    bannersCustom: function() {
        var collectionUrl = window.location.href;
        var newCollectionUrl = collectionUrl.replace('https://www.joiasbrasil.com.br', '');
        if (newCollectionUrl === "/busca/?fq=H:233") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/10-off-banner.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/10-off-mobile.jpg' complete='complete'></a></div>");
        } else if (newCollectionUrl === "/busca/?fq=H:234") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/20-off-banner.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/20-off-mobile.jpg' complete='complete'></a></div>");
        } else if (newCollectionUrl === "/busca/?fq=H:235") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/30-off-banner.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/30-off-mobile.jpg' complete='complete'></a></div>");
        } else if (newCollectionUrl === "/busca/?fq=H:341") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/andarfe.jpg' complete='complete'></a></div>");
            // $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/30-off-mobile.jpg' complete='complete'></a></div>");
        } else if (newCollectionUrl === "/busca?fq=H:357") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/colecao-amuleto.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Banner Categoria' src='/arquivos/colecao-amuleto-mobile.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/busca?fq=H:363") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias Brasil Dia dos Namorados' src='/arquivos/jb-Banner_Topo_categoria_Namorados.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias Brasil Dia dos Namorados' src='/arquivos/jb-banner-categoria-namorados-mobile.jpg' complete='complete'></a></div>");

        }else if (newCollectionUrl === "/joias/More%20&%20More?map=c,specificationFilter_166") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='More & More' src='/arquivos/moremoredesk.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='More & More' src='/arquivos/moremoremob.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/joias/Jardim%20Secreto?map=c,specificationFilter_166") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Jardim Secreto' src='/arquivos/jardimsecretodesk.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Jardim Secreto' src='/arquivos/jardimsecretomob.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/joias/At%20The%20Top?map=c,specificationFilter_166") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='At The Top' src='/arquivos/atthetopdesk.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='At The Top' src='/arquivos/atthetopmob.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/joias/Joias%20com%20diamantes?map=c,c,specificationFilter_125") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias com Diamantes' src='/arquivos/diamantedesk.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias com Diamantes' src='/arquivos/diamantemob.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/joias/Esmeralda?map=c,specificationFilter_69") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias com Esmeralda' src='/arquivos/esmeraldadesk.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias com Esmeralda' src='/arquivos/esmeraldamob.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/joias/Joias%20com%20p%C3%A9rolas?map=c,specificationFilter_125") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias com Perolas' src='/arquivos/peroladesk.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias com Perolas' src='/arquivos/perolamob.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/joias/Rubi?map=c,specificationFilter_69") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='At The Top' src='/arquivos/rubidesk.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='At The Top' src='/arquivos/rubimob.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/busca?fq=H:191") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Pedras Brasileiras' src='/arquivos/jb-Festival-das-pedras-topo-categoria.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Pedras Brasileiras' src='/arquivos/jb-Festival-das-Pedras-topo-mobile.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/busca?fq=H:323") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias Brasil' src='/arquivos/jb-Festival-das-pedras-topo-categoria-DIAMANTE.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias Brasil' src='/arquivos/jb-Festival-das-Pedras-topo-mobile-DIAMANTE.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/busca/?fq=H:386") {
            $('.result-search .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias Brasil' src='/arquivos/joiasbrasil-topo-categoria.jpg' complete='complete'></a></div>");
            $('.result-search .position-4 .mobile').append("<div class='box-banner'><a><img width='640' height='436' alt='Joias Brasil' src='/arquivos/joiasbrasil-topo-mobile.jpg' complete='complete'></a></div>");
        }else if (newCollectionUrl === "/joias") {
            $('.category .position-4 .desk').append("<div class='box-banner'><a><img width='1920' height='400' alt='Joias Brasil' src='/arquivos/joiasbrasil-topo-categoria.jpg' complete='complete'></a></div>");
            $('.category .position-4 .mobile').append("<div class='box-banner'><a><img width='640' height='436' alt='Joias Brasil' src='/arquivos/joiasbrasil-topo-mobile.jpg' complete='complete'></a></div>");
        }
    },
    init: function() {
...
var NewsPopup = {
        ...
        $(".enviarFormNews").click(function() {
            ...
            function validate() {
                ...
                if (validateEmail(npEmail)) {
                    ...
                    $('#npEmail').css('border', '1px solid #eb4d4b');
            ...
            if (varN == '') {
                $('#npNome').css('border', '1px solid #eb4d4b');
            ...
            function enviaDados() {
                ...
                $.ajax({
                    ...
                    success: function success(data) {
                        ...
                        $("#formNp").html("<p id='msgSucesso'>Mensagem enviada com sucesso =)</p>");
                    },
    ...
    init: function() {
        NewsPopup.newsletterPopUp();
    }
}
NewsPopup.init();

function loadAfterDOM() {
    $('.box.year').vtexCountdown();
}
setTimeout(loadAfterDOM(), 2000);