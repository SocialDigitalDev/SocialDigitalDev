...
QUALQUER ALTERAÇÃO FEITA NO gulpfile.babel.js OU NA PASTA node_modules, PRECISAM SER ACOMPANHADAS DO PROCEDIMENTO ABAIXO:

1 - Delete o conteúdo do arquivo npm-shrinkwrap.json
...
3 - Execute npm install para que o arquivo seja preenchido novamente
4 - Pronto. Pode executar "gulp serve".
