...
$(document).ready(function(){
    ...
    let qtdParcelas = 0
    var settings = {
        "url": "/api/catalog_system/pub/products/search?ft=bia todo dia",
        "method": "GET"
    };
            ...
            if(response[i].productId == '170778015'){
                for(var x = 0; response[i].items[0].images.length > x; x++){
                    if(response[i].items[0].images[x].imageLabel == "thumb"){
                        $('.thumb-170778015').append('<img src="'+response[i].items[0].images[x].imageUrl+'" alt="Cor High Cover" id="'+response[i].items[0].itemId+'"/>')
                    }
                }
            }else if(response[i].productId == '170778038'){
                for(var x = 0; response[i].items[0].images.length > x; x++){
                    if(response[i].items[0].images[x].imageLabel == "thumb"){
                        $('.thumb-170778038').append('<img src="'+response[i].items[0].images[x].imageUrl+'" alt="Cor High Cover" id="'+response[i].items[0].itemId+'"/>')
                    }
                }
            }else if(response[i].productId == '170778049'){
                for(var x = 0; response[i].items[0].images.length > x; x++){
                    if(response[i].items[0].images[x].imageLabel == "thumb"){
                        $('.thumb-170778049').append('<img src="'+response[i].items[0].images[x].imageUrl+'" alt="Cor High Cover" id="'+response[i].items[0].itemId+'"/>')
                    }
                }
            }
                ...
                for(var x = 0; response[i].items[0].images.length > x; x++){
                    if(response[i].items[0].images[x].imageLabel == "thumb"){
                        $('.thumb-170778060').append('<img src="'+response[i].items[0].images[x].imageUrl+'" alt="Cor High Cover" id="'+response[i].items[0].itemId+'"/>')
                    }
                }
            } else if(response[i].productId == '170778071'){
                for(var x = 0; response[i].items[0].images.length > x; x++){
                    if(response[i].items[0].images[x].imageLabel == "thumb"){
                        $('.thumb-170778071').append('<img src="'+response[i].items[0].images[x].imageUrl+'" alt="Cor High Cover" id="'+response[i].items[0].itemId+'"/>')
                    }
                }
            }
        }
    ...
    function loadProduct(id){
        ...
        for(var i = 0; arrayProducts.length > i; i++){
            if(arrayProducts[i].productId == id){
                ...
                titleCor = titleCor.replace('Bia todo dia', '');
                $('.title-cor').html(titleCor)
