const Methods = {
    ...
    filter() {
        ...
        $(`.js--open-filter`).live(`click`, function() {
            $(`.js--content-filter`).toggleClass(`is--active`);
        });
        ...
        $(`.js--content-filter h3 a`).text(`Categorias`);
    ...
    moveBreadcrumb() {
        ...
        const parent = document.querySelector(`.j-category__grid .main`);
    ...
    scrollToTop() {
        ...
        const pageTop = document.querySelector('#topo');
