...
var depto = {
    ...
    filtroCategoria: function () {
        if ($("body").hasClass("om-departamento") || $("body").hasClass("categoria")) {
    ...
    mudarExibicaoGridProdutos: function(){
        ...
        $('.exb-two').click(function(){
            ...
            $('.om-prateleira ul li').css('width', '33%');
            if (scre <= 768) {
                $('.om-prateleira ul li').css('width', '100%');
            }
        });
        $('.exb-three').click(function(){
            ...
            $('.exb-four').removeClass('exb-active');
            $('.om-prateleira ul li').css('width', '25%');
            if (scre <= 768) {
                $('.om-prateleira ul li').css('width', '50%');
            }
        });
        $('.exb-four').click(function(){
            ...
            $('.exb-two').removeClass('exb-active');
            $('.exb-three').removeClass('exb-active');
            $('.om-prateleira ul li').css('width', '20%');
        });
    },
